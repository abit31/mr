...
<html>
  ...
  <body class="skin-blue">
   ...
   <h1>
               ...
               <button  class="btn btn-success" onclick="myFunction()"> <i class="fa fa-save"></i> PRINT</button>
              <a href="index.php?page=data_pembelian" class="btn btn-danger"> <i class="fa fa-times"></i>CANCEL</a>
          </h1>
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <?php require_once('mod_details.php'); ?>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">AGMKS - Machine Record</a></strong>
      </footer>
    </div><!-- ./wrapper -->
