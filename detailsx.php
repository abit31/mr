      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
               ...
               <button type="submit" class="btn btn-success"> <i class="fa fa-save"></i> PRINT</button>
              <a href="download.php"><button type="reset" class="btn btn-warning"> <i class="fa fa-backward"></i> DOWNLOAD</button></a>
