...
<html>
  <head>
    <meta charset="UTF-8">
  <title>Machine Record - <?php require('get_title.php'); ?></title>
   ...
   <!--  <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" /> -->
    ...
    <script type="text/javascript">
        function EnableDisableTextBox(ddlModels) {
            ...
            var txtfinish = document.getElementById("txtfinish");
    
            txtfinish.disabled= selectedValue == 2 ? false : true;
            txtcontinue.disabled = selectedValue == 1 ? false : true;
            if (txtfinish.disabled) {
                txtfinish.focus();
            }
        }
    </script>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>Machine Record</b></a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="customer") { echo "active"; } ?>">
              <a href="./?page=data_user">
                <i class="fa fa-user"></i> <span>Data Customer</span> 
              </a>
            </li>
            
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="machinerecord") { echo "active"; } ?>">
              <a href="./?page=machinerecord">
                <i class="fa fa-money"></i> <span>Machine Record</span> 
              </a>
            </li>
          ...
          <?php else: ?>
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_pembelian") { echo "active"; } ?>">
              <a href="tambah.php?tambah=data_pembelian">
                <i class="fa fa-money"></i> <span>Tambah Machine Record</span> 
              </a>
            </li>
    ...
    <h1>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Machine Record</a></strong>
      </footer>
    </div><!-- ./wrapper -->
